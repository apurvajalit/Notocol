/*
 AngularJS v1.5.0-build.4389+sha.2e23a3c
 (c) 2010-2015 Google, Inc. http://angularjs.org
 License: MIT
*/
(function (y, e, z) {
    'use strict'; function A(a) { var d = []; t(d, e.noop).chars(a); return d.join("") } function g(a, d) { var b = {}, c = a.split(","), l; for (l = 0; l < c.length; l++) b[d ? e.lowercase(c[l]) : c[l]] = !0; return b } function B(a, d) {
        null === a || a === z ? a = "" : "string" !== typeof a && (a = "" + a); f.innerHTML = a; var b = 5; do { if (0 === b) throw u("uinput"); b--; 11 >= document.documentMode && n(f); a = f.innerHTML; f.innerHTML = a } while (a !== f.innerHTML); for (b = f.firstChild; b;) {
            switch (b.nodeType) {
                case 1: d.start(b.nodeName.toLowerCase(), C(b.attributes));
                    break; case 3: d.chars(b.textContent)
            } var c; if (!(c = b.firstChild) && (1 == b.nodeType && d.end(b.nodeName.toLowerCase()), c = b.nextSibling, !c)) for (; null == c;) { b = b.parentNode; if (b === f) break; c = b.nextSibling; 1 == b.nodeType && d.end(b.nodeName.toLowerCase()) } b = c
        } for (; b = f.firstChild;) f.removeChild(b)
    } function C(a) { for (var d = {}, b = 0, c = a.length; b < c; b++) { var l = a[b]; d[l.name] = l.value } return d } function v(a) {
        ...
        var b = !1, c = e.bind(a, a.push); return {
            start: function (a, h) { a = e.lowercase(a); !b && F[a] && (b = a); b || !0 !== r[a] || (c("<"), c(a), e.forEach(h, function (b, h) { var f = e.lowercase(h), g = "img" === a && "src" === f || "background" === f; !0 !== G[f] || !0 === w[f] && !d(b, g) || (c(" "), c(h), c('="'), c(v(b)), c('"')) }), c(">")) }, end: function (a) {
                a = e.lowercase(a); b || !0 !== r[a] || !0 === x[a] || (c("</"), c(a), c(">")); a ==
                b && (b = !1)
            }, chars: function (a) { b || c(v(a)) }
        }
    ...
    !0), G = e.extend({}, w, m, s), f; (function (a) { if (a.document && a.document.implementation) a = a.document.implementation.createHTMLDocument("inert"); else throw u("noinert"); var d = (a.documentElement || a.getDocumentElement()).getElementsByTagName("body"); 1 === d.length ? f = d[0] : (d = a.createElement("html"), f = a.createElement("body"), d.appendChild(f), a.appendChild(d)) })(y); e.module("ngSanitize", []).provider("$sanitize", function () {
        var a = !1; this.$get = ["$$sanitizeUri", function (d) {
            a && e.extend(r, H); return function (a) {
                var c =
                []; B(a, t(c, function (a, b) { return !/^unsafe:/.test(d(a, b)) })); return c.join("")
            }
        }]; this.enableSvg = function (d) { return e.isDefined(d) ? (a = d, this) : a }
    }); e.module("ngSanitize").filter("linky", ["$sanitize", function (a) {
        var d = /((ftp|https?):\/\/|(www\.)|(mailto:)?[A-Za-z0-9._%+-]+@)\S*[^\s.;,(){}<>"\u201d\u2019]/i, b = /^mailto:/i; return function (c, f, h) {
            function g(a) { a && p.push(A(a)) } function m(a, b) {
                var c; p.push("<a "); e.isFunction(h) && (h = h(a)); if (e.isObject(h)) for (c in h) p.push(c + '="' + h[c] + '" '); else h = {}; !e.isDefined(f) ||
                "target" in h || p.push('target="', f, '" '); p.push('href="', a.replace(/"/g, "&quot;"), '">'); g(b); p.push("</a>")
            } if (!c) return c; for (var q = c, p = [], k, n; c = q.match(d) ;) k = c[0], c[2] || c[4] || (k = (c[3] ? "http://" : "mailto:") + k), n = c.index, g(q.substr(0, n)), m(k, c[0].replace(b, "")), q = q.substring(n + c[0].length); g(q); return a(p.join(""))
        }
    }])
